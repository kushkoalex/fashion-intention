module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        sourceDir: '../sources/',
        publicDir:publicDir,
        prodBuildDir: '../../fashion-intention-build/',
        ...
        tags:{
            buildDevScripts:{
                ...
                src: [
                    ...
                    '<%= scriptsDir %>fashionIntention/FIN.js',
                    '<%= scriptsDir %>fashionIntention/modules/**/*.js',
                    '<%= scriptsDir %>fashionIntention/elements/**/*.js',
                    '<%= scriptsDir %>fashionIntention/**/*.js',
